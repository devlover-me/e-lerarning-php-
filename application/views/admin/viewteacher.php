			...
			<div class="col-md-12">
				<div class="card card-plain">
					<div class="card-header card-header-primary">
						<div class="row">
							<div class="col-md-6">
								<h4 class="card-title mt-0">View Teacher</h4>
							</div>
							<div class="col-md-6">
								<a class="btn btn-warning" href="<?php $action='add';
								 echo base_url('admin/editTeacher/'.$action); ?>"
									style="float: right;">Add Teacher</a>
							</div>
						</div>
							...
							<table class="table table-hover" id="sample_1">
								...
								<tbody>
									...
									<td><?php if ($key->status == 0) { ?><a
										...
										echo base_url('admin/editTeacher/').$action.'/'.$key->id; ?>"><i
...
<script>
	function myFunction(id) {
		...
		swal({
			...
			.then((willDelete) => {
				if (willDelete) {
					window.location.href = "<?php echo base_url(); ?>admin/deleteTeacher/" + id;
