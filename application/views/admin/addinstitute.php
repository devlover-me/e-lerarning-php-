					...
					<div class="card-header card-header-primary">
						<div class="row">
							...
							<div class="col-md-6">
								...
								echo base_url('admin/viewInstitute/').$uid; ?>"
					...
					echo form_open_multipart('admin/saveInstitute/'.$action);
					 ...
					 if(form_error('name')){
							 echo set_value('name');}else{
								if($action=='edit'){ 
							 echo $data[0]->instituteName;} else{
								echo set_value('name'); 
               } } ?>"
								 required>
					 ...
					 if(form_error('year')){
							 echo set_value('year');}else{
								if($action=='edit'){ 
							 echo $data[0]->phaseYear;} else{
								echo set_value('year'); 
               } } ?>"
								 required>
					 ...
					 if(form_error('month')){
							 echo set_value('month');}else{
								if($action=='edit'){ 
							 echo $data[0]->phaseMonth;} else{
