			...
			<div class="col-md-12">
				...
				<div class="form-group">
					...
					<input type="text" name="nod" class="form-control " value="<?php 
					 if(form_error('nod')){ echo set_value('nod');}else{
					if($action=='edit'){ echo $userInfo[0]->nameOfDirector;} else{
						echo set_value('nod'); 	   } } ?>" id="" required>	 
                ...
                <label for="exampleInputPassword1"> Oraganization Name *</label>
					<input type="text" name="orgName" class="form-control " value="<?php 
					 if(form_error('orgName')){ echo set_value('orgName');}else{
					if($action=='edit'){ echo $userInfo[0]->oraganizationName;} else{
				echo set_value('orgName');  } } ?>" id="" required>
				...
				<div class="form-group">
					...
					if($action=='edit'){  echo $user[0]->userName;} else{
				...
				<div class="form-group">
                   <label for="exampleInputPassword1"> Director father name *</label>
					<input type="text" name="faName" class="form-control " value="<?php 
					 if(form_error('faName')){ echo set_value('faName');}else{
						if($action=='edit'){ echo $userInfo[0]->directorFather;} else{		
							echo set_value('faName');   } } ?>" id="" required>		 
				...
				<div class="form-group">
					...
					<input type="text" name="aadhar" maxlength="12" class="form-control " value="<?php 
					 if(form_error('aadhar')){ echo set_value('aadhar');}else{
						if($action=='edit'){ echo $userInfo[0]->aadharNumber;} else{
							echo set_value('aadhar');  } } ?>" id="" required>		
				...
				<div class="form-group">
					...
					<input type="text" name="phone" maxlength="10" class="form-control " value="<?php 
					 if(form_error('phone')){ echo set_value('phone');}else{
						if($action=='edit'){ echo $user[0]->phone;		} else{	
							echo set_value('phone');   } } ?>" id="" required>	
			...
			<?php echo form_error('phone','<div class="error" style="color:red;">', '</div>'); ?>
				...
				<div class="form-group">
					...
					<input type="text" name="email" class="form-control " value="<?php 
					 if(form_error('email')){ echo set_value('email');}else{
						if($action=='edit'){ 	echo $user[0]->email;} else{	
							echo set_value('email');   } } ?>" id="" required>		
				...
				<div class="form-group">
					...
					<input type="text" name="address" class="form-control " value="<?php 
					 if(form_error('address')){echo set_value('address');}else{
						if($action=='edit'){echo $userInfo[0]->address;} else{	 
							echo set_value('address'); 	   } } ?>" id="" required>	 
				...
				<div class="form-group">
					...
					<input type="text" name="dob" class="form-control " value="<?php 
					 if(form_error('dob')){ echo set_value('dob');}else{
						if($action=='edit'){echo $userInfo[0]->dob;} else{		
							echo set_value('dob'); 	 } } ?>" id="" required>	 
