			...
			<div class="col-md-12">
				<div class="card card-plain">
					<div class="card-header card-header-primary">
						<div class="row">
							<div class="col-md-6">
								<h4 class="card-title mt-0">View Category</h4>
							</div>
							<div class="col-md-6">
								<a class="btn btn-warning" href="<?php $action='add';
								 echo base_url('admin/Category/'.$action); ?>" style="float: right;">Add Category</a>
							</div>
						</div>
								...
								<tbody>
									...
									$date = new DateTime($source);echo $date->format('d.m.Y');?></td>
										...
										<td><?php if ($key->status == 0) { ?><a
												href="<?php echo base_url('admin/changeCategoryStatus/').$key->id; ?>"><i
										...
										echo base_url('admin/Category/').$action.'/'.$key->id; ?>"><i class="fas fa-edit"></i></a>
...
<script>
	function myFunction(id) {
		...
		swal({
				title: "Are you sure?",
				text: "Once deleted, your all the data related to the Category will be deleted!",
				icon: "warning",
				buttons: true,
				dangerMode: true,
			})
